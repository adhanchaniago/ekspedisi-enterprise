                                ...
                                <li>
                                    ...
                                    <li>
                                        ...
                                        <aside class="menu-sidebar d-none d-lg-block">
                                            <div class="logo">
                                                <a href="#">
                                                    <img src="<?php echo base_url('assets/') ?>images/icon/jnt-logo.png" alt="Cool Admin" />
                                                </a>
                                            </div>
                                                            ...
                                                            <div class="header-button">
                                                                ...
                                                                <div class="account-wrap">
                                                                    <div class="account-item clearfix js-item-menu">
                                                                        <div class="image">
                                                                            <img src="<?php echo base_url('assets/') ?>images/icon/avatar-01.jpg" alt="<?php echo $this->session->userdata('logged_in')['nama'] ?>" />
                                                                        </div>
                                                                        <div class="content">
