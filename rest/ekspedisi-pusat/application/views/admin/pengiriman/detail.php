                            ...
                            <form action="" method="post" class="form-horizontal" id="form-input-direct">
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="input-fk_paket" class=" form-control-label">Resi</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <select name="fk_paket" id="input-fk_paket" class="form-control">
                                            <option disabled="" selected="" value="">Pilih paket</option>
                                            <?php foreach ($paket['direct'] as $value): ?>
                                                <option value="<?php echo $value->id ?>"><?php echo $value->nama_kota ?> <?php echo $value->resi ?></option>
                                            <?php endforeach ?>
                                        </select>
                                        <script>$("#input-fk_paket").val("<?php echo set_value("fk_paket") ?>");</script>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                            ...
                            <form action="" method="post" class="form-horizontal" id="form-input-transit">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="fk_paket" id="input-fk_paket" class="form-control">
                                            <option disabled="" selected="" value="">Pilih paket</option>
                                            <?php foreach ($paket['transit'] as $value): ?>
                                                <option value="<?php echo $value->id ?>"><?php echo $value->nama_kota ?> <?php echo $value->resi ?></option>
                                            <?php endforeach ?>
                                        </select>
                                        <script>$("#input-fk_paket").val("<?php echo set_value("fk_paket") ?>");</script>
