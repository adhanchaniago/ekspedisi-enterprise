            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        ...
                        <a href="<?php echo base_url('Admin/Penerimaan') ?>" class="au-btn au-btn-icon btn-secondary">
                            Kembali
                        </a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <div class="table-data-feature">
                                                    <a href="<?php echo base_url("Admin/Penerimaan/terima/".$this->uri->segment(4)."/".$value->id) ?>" class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Terima">
